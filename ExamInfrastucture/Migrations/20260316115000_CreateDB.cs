    ...
    public partial class CreateDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamAccessCodes", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamAccessCodes_Exams_ExamId1",
                        column: x => x.ExamId1,
                        principalTable: "Exams",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ExamAccessCodes_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamAccessCodes_Students_StudentId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentAnswers_ExamOptions_SelectedOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamAccessCodes_ExamId_StudentId",
                table: "ExamAccessCodes",
                columns: new[] { "ExamId", "StudentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ExamAccessCodes_ExamId1",
                table: "ExamAccessCodes",
                column: "ExamId1");

            migrationBuilder.CreateIndex(
                name: "IX_ExamAccessCodes_StudentId",
                table: "ExamAccessCodes",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamAccessCodes_StudentId1",
                table: "ExamAccessCodes",
                column: "StudentId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAnswers_StudentExamId_ExamQuestionId",
                table: "StudentAnswers",
                columns: new[] { "StudentExamId", "ExamQuestionId" },
                unique: true);
